<div align="center" style="background-color: #0d1117; padding: 60px 40px; border-radius: 20px; border: 1px solid #21262d; max-width: 1000px; margin: 0 auto; color: #c9d1d9;">
  ...
  <h1 style="font-size: 3.8rem; margin: 0 0 8px; color: #c9d1d9; letter-spacing: -2px;">
    John-BrenoF
  </h1>

  <p style="font-size: 1.6rem; color: #8b949e; margin: 0 0 50px;">
  ...
  <h2 style="color: #ff79c6; font-size: 2.2rem; margin: 0 0 30px;">
    PROJETOS DE ORGULHO
 <hr style="border: 0; height: 1px; background: #30363d; margin: 60px 0 40px;" />
